...
export default function AllApartments() {
  ...
  const [visibleCount, setVisibleCount] = useState(6); // Initially show 6 apartments
  ...
  const handleSeeMore = () => {
    setVisibleCount(prev => prev + 6); // Load 6 more apartments
  };
    ...
    <div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {localized.slice(0, visibleCount).map((apartment, index) => {
          const swiperId = `swiper-${apartment.id}`; // Unique ID for each swiper
          ...
          return (
            ...
            >
              ...
              <div className="p-4 flex flex-col gap-3">
                ...
                <p className="text-gray-800 text-base leading-relaxed">{apartment.price}</p>
